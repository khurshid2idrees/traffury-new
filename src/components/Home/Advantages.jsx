...
call-center </p>
                    ...
                    <img src={inhouseicon} width={170} alt="" />
                        {/* <span class="p-5 rounded-full bg-lime-500 text-white noshaddow-lg noshaddow-lime-200"><svg
                            xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                        </svg></span> */}

                        <p class="text-xl font-semibold  text-white mt-6">Affscale - Global personnel
                        </p>
                        {/* <p class="mt-2 text-sm text-slate-500">Receive weekly payments, without incurring inconvenience delays. Withdraw earnings anyway you like</p> */}
                    </div>

                    <div class="p-10 flex flex-col items-center text-center group    md:lg:xl:borderremove-r   cursor-pointer">
                    <img src={personalicon} width={170} alt="" />

                        {/* <span class="p-5 rounded-full bg-teal-500 text-white noshaddow-lg noshaddow-teal-200"><svg
                            xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round"
...
manager 
                        ...
                        {/* <p class="mt-2 text-sm text-slate-500">Connect partners with diverse Asian staffs to optimize advertising resources and closely aligned with local customers
                        </p> */}
                    </div>
                    ...
                    <img src={geoicon} width={170} alt="" />
                        ...
                        {/* <span class="p-5 rounded-full bg-indigo-500 text-white noshaddow-lg noshaddow-indigo-200"><svg
                            xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round"
...
manager 
                        ...
                        {/* <p class="mt-2 text-sm text-slate-500">Native translate and unique content creation
                        </p> */}
                    </div>
